...
class TestSafeEmitSgr < Minitest::Test
  ...
  def test_string_with_manual_sgr_isolated
    ...
    expected = "before \e[31mred\e[0m after\e[1mbold\e[0m"
  ...
  def test_multiple_manual_sgr_codes_contained
    ...
    expected = "text \e[1mbold\e[0m \e[31mred\e[0m end\e[4munderlined\e[0m"
    assert_equal expected, result
  end
  ...
  def test_manual_sgr_does_not_leak_to_tags
    ...
    expected = "start \e[31mred text\e[39;1mshould be bold not red\e[0m"  # 31 preserved, reset to default, then bold applied
    assert_equal expected, result
  end
  ...
  def test_wrapped_content_isolated
    ...
    expected = "before wrapped \e[31mred\e[0m content after\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_nested_wrapped_content
    ...
    expected = "start outer inner \e[1mbold\e[0m text end"
    assert_equal expected, result
  end
  ...
  def test_builder_method_with_manual_sgr
    ...
    expected = "\e[31mplain text with manual red\e[0m \e[31;1mbold text\e[0m"
    assert_equal expected, result
  end
  ...
  def test_multiple_manual_resets_in_sequence
    ...
    expected = "\e[34mstart \e[31mred\e[0m middle \e[32mgreen\e[0m end\e[34;1mfinal\e[0m"
    assert_equal expected, result
  end
  ...
  def test_nested_manual_sgr_with_builder_tags
    ...
    expected = "\e[31;1mbold with \e[33myellow\e[0m inside\e[31m after bold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_partial_manual_sgr_codes
    ...
    expected = "\e[31mred \e[32mgreen\e[0m back\e[31;1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_mixed_sgr_and_wrapping_complex
    ...
    expected = "start " +
               "\e[1mbold wrap1 \e[32mgreen\e[39m continue" +
  ...
  def test_empty_wrapped_content
    ...
    expected = "before  after\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_unwrapped_string_with_sgr
    ...
    result = @go[text_with_sgr, :bold, "bold"]
    expected = "plain \e[31mred\e[0m text\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_unwrapped_with_wrapped_inside
    ...
    expected = "before wrapped \e[4munderline\e[0m after \e[31mred\e[0m end"
    assert_equal expected, result
  end
  def test_malformed_sgr_incomplete_escape
    ...
    expected = "text \e[31 incomplete and \e[4 another\e[1mbold\e[0m"  # passed through as-is
    assert_equal expected, result
  end
  ...
  def test_complex_sgr_sequences
    ...
    expected = "start \e[31;4;1mbold red underline\e[0m end\e[3mitalic\e[0m"
    assert_equal expected, result
  end
  ...
  def test_non_sgr_escape_sequences
    ...
    expected = "line1\e[2Jclear\e[H home\e[1mbold\e[0m"  # non-SGR escapes preserved
    assert_equal expected, result
  end
  ...
  def test_deeply_nested_wrapping
    ...
    expected = "start level1 level2 level3 \e[35mmagenta\e[0m text text end"
    assert_equal expected, result
  end
  ...
  def test_empty_wraps_in_middle
    ...
    expected = "start  middle \e[32mgreen\e[0m  end"  # empty wraps become spaces
    assert_equal expected, result
  end
  ...
  def test_mismatched_wrap_markers_extra_close
    ...
    expected = "text#{Gouache::WRAP_CLOSE}extra\e[1mbold\e[0m"  # close marker as literal
    assert_equal expected, result
  end
  ...
  def test_mismatched_wrap_markers_extra_open
    ...
    result = @go[text_with_extra, :bold, "bold"]
    expected = "text#{Gouache::WRAP_OPEN}extra\e[1mbold\e[0m"  # open marker as literal
    assert_equal expected, result
  end
  ...
  def test_builder_chaining_with_wrapped_content
    ...
    expected = "\e[1mbefore \e[3mitalic wrapped \e[31mred\e[39m content text\e[23m after\e[0m"
    assert_equal expected, result
  end
  ...
  def test_multiple_wrap_levels_with_builder_tags
    ...
    expected = "\e[31;1mbold middle inner \e[4munderline\e[24m text content\e[0m"
    assert_equal expected, result
  end
  ...
  def test_wrap_markers_at_string_start
    ...
    expected = "\e[33myellow\e[0m startrest\e[1mbold\e[0m"  # wrapped content extracted
    assert_equal expected, result
  end
  ...
  def test_wrap_markers_at_string_end
    ...
    expected = "startend \e[33myellow\e[39;1mbold\e[0m"  # wrapped content extracted
    assert_equal expected, result
  end
  ...
  def test_complex_interpolation_multiple_variables
    ...
    expected = "start first \e[31mred\e[0m middle manual \e[34mblue\e[0m " +
               "\e[1mbold second \e[32mgreen\e[39m content third \e[33myellow\e[39m end\e[0m"
    assert_equal expected, result
  end
  ...
  def test_class_wrap_method
    ...
    expected = "before class wrap \e[31mred\e[0m test after\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_class_embed_alias
    ...
    expected = "before class embed \e[32mgreen\e[0m test after\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_instance_wrap_method
    ...
    expected = "before instance wrap \e[33myellow\e[0m test after\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_instance_embed_alias
    ...
    expected = "before instance embed \e[34mblue\e[0m test after\e[1mbold\e[0m"
    assert_equal expected, result
  end
  ...
  def test_mixed_class_instance_wrap_methods
    ...
    expected = "start class \e[35mmagenta\e[0m middle" +
               "\e[1mbold instance \e[36mcyan\e[39m end\e[0m"
    assert_equal expected, result
  end
end
